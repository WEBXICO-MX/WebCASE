...
<title>UTTAB &#124; Centro de Atención al Sector Energético |
	Tipo(s) Medio(s) de Comunicación | Create</title>
<meta charset="UTF-8">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<a href="<c:url value='/tiposmedioscomunicacion' />"
				...
				<form:form action="${addAction}" commandName="tipoMedioComunicacion"
					...
					<div class="form-group">
						<form:label path="nombre"><spring:message text="Nombre" /></form:label>
						<form:input path="nombre" cssClass="form-control" />
					</div>
					<div class="form-group">
						<form:label path="img">	<spring:message text="URL imagen" /></form:label>
						<form:input path="img" size="70" maxlength="100" cssClass="form-control" />
					</div>
					<div class="checkbox">
