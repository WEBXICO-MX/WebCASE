	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<br /> <a href="<c:url value='/capacitaciones/new' />"
					class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>
					New Capacitaciones</a><br />
				<br />
						...
						<tbody>
							<c:forEach items="${listCapacitacion}" var="capacitacion">
								<tr>
									...
									<td><c:choose>
											<c:when test="${capacitacion.activo}">
									...
									<td><a
										href="<c:url value='/capacitaciones/${capacitacion.id}/edit' />"
				...
				<br />
				<br /> <a href="<c:url value='/home' />" class="btn btn-primary"><span
					class="glyphicon glyphicon-chevron-left"></span> Back</a><br />
				<br /> <a href="<c:url value='/capacitaciones/new' />"
					class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>
					New Capacitaciones</a><br />
