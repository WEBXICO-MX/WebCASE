...
<html lang="es">
<head>
<title>UTTAB &#124; Centro de Atención al Sector Energético | Calendario de capacitaciones| Crear</title>
<meta charset="UTF-8">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<a href="<c:url value='/calendarioscapacitaciones' />"	class="btn btn-primary"><span class="glyphicon glyphicon-chevron-left"></span> Back</a><br />
				<h3 class="text-center">Calendario de capacitaciones</h3>
				
				<c:url var="addAction" value="/calendarioscapacitaciones/create"></c:url>
				<form:form action="${addAction}" commandName="calendarioCapacitacion" role="form">
						<div class="form-group">
							<form:label path="capacitacion_id">	<spring:message text="Capacitación" /> </form:label>
							<form:select path="capacitacion_id.id" class="form-control">
                                ...
                                <div class="date-form">
                                    <div class="form-horizontal">
                                        <div class="control-group">
                                            <form:label path="fecha_inicio"> <spring:message text="Fecha inicio" />	</form:label>
                                            <div class="controls">
                                                <div class="input-group">
                                                    <form:input path="fecha_inicio" cssClass="date-picker form-control" size="10" readonly="true"/>
                        ...
                        <div class="form-group">
                                <div class="date-form">
                                    <div class="form-horizontal">
                                        <div class="control-group">
                                            <form:label path="fecha_fin"> <spring:message text="Fecha fin" /> </form:label>
                                            <div class="controls">
                                                <div class="input-group">
                                                    <form:input path="fecha_fin" cssClass="date-picker form-control"	size="10" readonly="true" />
                                                    <label class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
                                                </div>
                                            </div>
                                        </div>
